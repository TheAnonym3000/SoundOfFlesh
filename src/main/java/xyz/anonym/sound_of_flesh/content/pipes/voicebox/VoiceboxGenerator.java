...
public class VoiceboxGenerator extends SpecialBlockStateGen {
    ...
    public <T extends Block> ModelFile getModel(DataGenContext<Block, T> ctx, RegistrateBlockstateProvider prov,
        ...
        String size = state.getValue(VoiceboxBlock.SIZE)
                .getSerializedName();
        boolean powered = state.getValue(VoiceboxBlock.POWERED);
        ...
        return prov.models()
                ...
                .texture("0", SoundOfFlesh.asResource("block/flesh_base"));
    }
