...
public class AllTabs {
    ...
    public static final RegistryObject<CreativeModeTab> MAIN = CREATIVE_MODE_TABS.register("main", () -> CreativeModeTab.builder().icon(() -> new ItemStack(AllBlocks.VOICEBOX.get())).displayItems((parameters, output) -> {
